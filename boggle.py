...
def neighbours_of_position(coords):
    ...
    #left to right
    left = (row, col - 1)
    #coordinates passed into this function are situated here
    right = (row, col + 1)
...
def all_grid_neighbours(grid):
    ''' 
    get all of the possible neighbours_of_positionfor each position in the grid
    '''
    neighbours = {}
...
def search(grid, dictionary):
    '''
    search through the paths to locate words by matching strings to words in the 
    dictionary
    '''
